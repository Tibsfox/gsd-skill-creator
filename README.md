...
# Run skill-creator library tests (16,999 tests)
npm test
```
...
| [Requirements](docs/REQUIREMENTS.md) | All shipped requirements across 49 milestones |
...
49 milestones shipped (v1.0-v1.47 + v1.8.1 patch) | 433 phases | 1,031 plans | ~520k LOC TypeScript, Rust, GLSL, Bash & Python | 16,999 tests
