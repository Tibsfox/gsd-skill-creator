...
This constant group delay is a key advantage of linear-phase FIR filters: all frequencies are delayed by exactly the same amount, preserving the waveform shape.
...
This is the Nyquist frequency. Frequencies above 4000 Hz would alias (fold back) into the 0-4000 Hz range, producing false spectral content.
