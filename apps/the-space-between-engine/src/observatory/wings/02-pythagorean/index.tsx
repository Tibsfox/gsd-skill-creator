...
export interface PythagoreanWingProps {
...
export const WING_ID: FoundationId = 'pythagorean';
export const WING_NAME = 'Pythagorean Theorem';
export const WING_SUBTITLE = 'Relationship';

export const PythagoreanWing: React.FC<PythagoreanWingProps> = ({
  foundationId,
  learnerState,
  onPhaseComplete,
  onNavigate,
  ...
  return (
    <div className="wing pythagorean-wing">
      <header className="wing-header">
        <h1>Wing 2: {WING_NAME}</h1>
...
export default PythagoreanWing;
