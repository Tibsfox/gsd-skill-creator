 ...
 * From wonder at translation to building your own functor.
 */
...
export interface CategoryTheoryWingProps {
...
const FOUNDATION_ID = 'category-theory' as const;

export const CategoryTheoryWing: React.FC<CategoryTheoryWingProps> = ({
  initialPhase = 'wonder',
  onPhaseComplete,
  onWingComplete,
  onSaveCreation,
  ...
  return (
    <div className="observatory-wing category-theory-wing">
...
export default CategoryTheoryWing;
