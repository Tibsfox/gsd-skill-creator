 ...
 * From wonder at communication to encoding your own message.
 */
...
export interface InformationTheoryWingProps {
...
const FOUNDATION_ID = 'information-theory' as const;

export const InformationTheoryWing: React.FC<InformationTheoryWingProps> = ({
  initialPhase = 'wonder',
  onPhaseComplete,
  onWingComplete,
  onSaveCreation,
  ...
  return (
    <div className="observatory-wing information-theory-wing">
...
export default InformationTheoryWing;
