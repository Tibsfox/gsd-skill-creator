...
export interface TrigonometryWingProps {
...
export const WING_ID: FoundationId = 'trigonometry';
export const WING_NAME = 'Trigonometry';
export const WING_SUBTITLE = 'Motion';

export const TrigonometryWing: React.FC<TrigonometryWingProps> = ({
  foundationId,
  learnerState,
  onPhaseComplete,
  onNavigate,
  ...
  return (
    <div className="wing trigonometry-wing">
      <header className="wing-header">
        <h1>Wing 3: {WING_NAME}</h1>
...
export default TrigonometryWing;
