 ...
 */
function renderQuestionsSection(questions, helperUrl) {
    let cardsHtml;
...
// Settings section
// ---------------------------------------------------------------------------
function renderSettingsSection(config, helperUrl) {
 ...
 */
export function renderConsolePage(data) {
    const sections = [
 ...
 * @returns CSS string
 */
export function renderConsolePageStyles() {
    return `
/* -----------------------------------------------------------------------
   Console Page
   ----------------------------------------------------------------------- */
