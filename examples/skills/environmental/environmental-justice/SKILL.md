...
## What Environmental Justice Is and Is Not
...
### Warren County and the 1987 United Church of Christ report
...
- Race is the strongest predictor of hazardous facility proximity in the U.S., controlling for income.
- Air pollution exposure (PM2.5, NO2) is systematically higher for Black and Hispanic Americans.
- Drinking water violations are more common in small, rural, and tribal systems.
- Lead exposure is concentrated in old housing stock, correlated with race and income.
- Tribal lands face historical legacies of uranium mining, fossil fuel development, and military testing.
...
- **UN Declaration on the Rights of Indigenous Peoples (UNDRIP, 2007)** — affirms rights to self-determination, land, and free, prior, and informed consent (FPIC) for projects affecting indigenous territory.
- **ILO Convention 169 (1989)** — binding treaty on indigenous and tribal peoples' rights, ratified by 24 countries.
- **National recognition** — varies by country, from comprehensive (e.g., Bolivia, Norway) to nominal (e.g., many U.S. state and federal structures that recognize tribes but under-enforce obligations).
...
## Applying EJ in Practice

A project-level EJ analysis should answer at least six questions:

1. **Baseline disparity** — does the affected community already bear disproportionate environmental burden? (Screening tool + local data.)
2. **Project-specific exposure** — which community members will be exposed to which stressors, at what levels, via what pathways?
3. **Cumulative impact** — how does the project interact with existing stressors to produce total exposure?
4. **Procedural fairness** — was the community consulted early, meaningfully, and in accessible form?
5. **Benefit distribution** — who gets the benefits of the project (jobs, tax base, services)? Do they overlap with who bears the burden?
6. **Alternatives and mitigation** — were alternatives considered that would have produced the same benefit without the disparate burden?
...
- Evaluating the distributional consequences of a project, policy, or intervention
- Running or critiquing an EJ screening analysis
- Structuring community engagement for an impact assessment
- Reasoning about indigenous rights, FPIC, and traditional ecological knowledge
- Framing climate justice arguments at global or intergenerational scales
- Designing a "just transition" program
- Analyzing the siting history of hazardous facilities in a region

## When NOT to Use This Skill

- Ecology or community-level biology without a justice angle — use `ecosystem-dynamics`
- Biogeochemical cycles in their physical dimension — use `biogeochemical-cycles`
- Climate physics without distributional framing — use `climate-science`
- Impact assessment methodology without EJ framing — use `human-impact-assessment`
- Intervention design without distributional emphasis — use `sustainability-design`
...
- **shiva agent:** Agricultural justice, seed sovereignty, colonial critique
- **wangari agent:** Community organizing, gender and environment
- **carson agent:** Chemical exposure as a justice issue
- **human-impact-assessment skill:** The impact measurements EJ applies distributional analysis to
- **climate-science skill:** Climate physics underpinning climate justice
- **sustainability-design skill:** Intervention design that must consider distributional consequences
...
- First National People of Color Environmental Leadership Summit. (1991). *Principles of Environmental Justice*.
