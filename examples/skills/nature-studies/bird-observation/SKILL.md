...
Birds are the organism class most commonly observed by naturalists, in part because they are visible, abundant, and vocal, and in part because the citizen-science infrastructure around them is more mature than for any other group. Bird observation is also the best-documented entry point into field naturalism, with a century of literature on how to identify, record, and understand what birds do. This skill covers the core of that practice: how to see them, how to hear them, how to interpret what they are doing, and how to produce records that contribute to research.

**Agent affinity:** audubon (ID, illustration, voice), peterson (field-guide methodology, diagnostic features)

**Concept IDs:** nature-animals-birds, nature-citizen-science

## Seeing Birds

A bird is usually visible for seconds. What you capture in those seconds determines whether you can identify it later.

### The Sequence of Attention

Expert birders move their attention through a fixed sequence so nothing critical is missed.

1. **Size and shape.** Is it sparrow-sized, robin-sized, or larger? Is it stocky, slim, elongated? Long tail or short? Long legs or short?
2. **Field marks on the head.** Eye color, eye-ring, eye line, cap, throat, mustache, bill color and shape.
3. **Field marks on the wings.** Wing bars, edgings, primary projection, speculum.
4. **Field marks on the tail.** Bands, tips, outer tail color, shape.
5. **Underparts pattern.** Breast streaking, belly color, undertail coverts.
6. **Behavior.** Foraging style, flight pattern, posture.
7. **Habitat.** Where the bird was, what it was doing, what it was with.
...
|---|---|---|
| **Song** | Territorial advertising, mate attraction | American Robin's "cheerily-cheer-up" phrases |
| **Call** | Contact, alarm, flight | Black-capped Chickadee's "dee-dee-dee" |
| **Flight call** | Maintaining flock cohesion in flight | Warbler overnight migration calls |
| **Begging call** | Fledgling demanding food | Young jays rasping from the canopy |
| **Alarm call** | Predator warning | Crow mobbing call |
| **Drumming** | Woodpecker territorial signal | Downy Woodpecker's rapid roll |
| **Mechanical** | Non-vocal sound | Snipe winnowing, nighthawk booming |
...
1. **Mnemonics.** "Drink your tea" for the Eastern Towhee. "Teacher, teacher, teacher" for the Ovenbird. "Old Sam Peabody" for the White-throated Sparrow.
2. **Repeated exposure.** The Merlin Bird ID app, Cornell's Macaulay Library, and Xeno-canto host tens of thousands of recordings. Listening to known songs repeatedly builds the acoustic memory that field ID requires.
3. **Spectrogram reading.** The frequency-by-time visual of a recording. Spectrograms make song structure explicit and help a learner understand what feature of a song they are supposed to notice.
...
- **Effort type.** Stationary, traveling (with distance), incidental, area.
...
1. **Start with the sequence of attention.** Do not let one striking mark derail the rest of the observation.
2. **Use habitat as a filter before pattern.** Most misidentifications are plausible birds from the wrong habitat.
3. **Work by ear when you can.** An audio recording is a diagnostic record that photos cannot replace.
4. **Rate confidence, record, and submit.** Do not inflate rare reports, do not omit common ones. The citizen-science archive is only as good as the discipline of its contributors.
...
- Cornell Lab of Ornithology. *Macaulay Library*. https://www.macaulaylibrary.org/
- Xeno-canto. *Worldwide Bird Sounds*. https://xeno-canto.org/
