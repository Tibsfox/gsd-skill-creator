...
Use template from `/media/foxy/ai/GSD/dev-tools/artemis-ii/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/media/foxy/ai/GSD/dev-tools/artemis-ii/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/media/foxy/ai/GSD/dev-tools/artemis-ii/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
