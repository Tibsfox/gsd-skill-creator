...
first_path: .claude/agents/gsd-roadmapper.md
superseded_by: null
---
<role>
...
Reference full template: `/path/to/projectGSD/dev-tools/artemis-ii/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/path/to/projectGSD/dev-tools/artemis-ii/.claude/get-shit-done/templates/state.md`.
