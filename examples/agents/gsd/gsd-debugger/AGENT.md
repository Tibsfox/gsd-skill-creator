...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks /media/foxy/ai/GSD/dev-tools/artemis-ii/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /media/foxy/ai/GSD/dev-tools/artemis-ii/.claude/get-shit-done
                  → writes to /media/foxy/ai/GSD/dev-tools/artemis-ii/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/media/foxy/ai/GSD/dev-tools/artemis-ii/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/media/foxy/ai/GSD/dev-tools/artemis-ii/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/media/foxy/ai/GSD/dev-tools/artemis-ii/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
