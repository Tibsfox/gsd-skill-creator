...
**All 14 Tier-1 items are done** (INT-1, AC-1, LEARN-3, ORCH-1/2/3/N1, CC-2, CLI-1/2/3, B2, B9, QUAL-1a) plus eight Tier-2/§4.1 items (PG-2, PG-4, B10, **MEM-1**, **PG-1/PG-3**, **RET-1/RET-4**, **RET-5**, **PG-6**).
