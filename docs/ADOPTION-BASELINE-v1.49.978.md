...
Generated: 2026-06-05T02:35:14.689Z
Root: `.`

**Summary:** 151 modules — 98 living · 45 test-only · 8 isolated. **Reachability:** 83 reachable-from-production · 68 unreachable-from-production.
...
|--------|-------------:|:-----------:|------|
| `amiga` | 1 | yes | allowlisted (park/reference) |
...
| `commands` | 1 | yes | allowlisted (park/reference) |
...
| `cli` | 135 | 15 | 52 | `commands`, `scribe`, `skill` |
