...
layer: meta
path: "meta/index.md"
summary: "Documentation about the documentation — style, structure, contracts, and processes."
cross_references:
  ...
  - path: "meta/content-map.md"
    relationship: "gateway-to"
    description: "Complete content inventory"
  - path: "meta/site-architecture.md"
    relationship: "gateway-to"
    description: "Website structure and migration"
  - path: "meta/content-pipeline.md"
    relationship: "gateway-to"
    description: "docs/ to www/ transformation"
...
reading_levels:
  ...
  scan:
    - "Style guide — voice, tone, formatting, frontmatter schema"
    - "Filesystem contracts — who creates what, who consumes it"
    - "Content map — inventory of all published content"
