...
Generated: 2026-07-19T20:27:15.436Z
Root: `.`

**Summary:** 154 modules — 109 living · 39 test-only · 6 isolated. **Reachability:** 99 reachable-from-production · 55 unreachable-from-production.
...
| `cartridge` | 70 | 3 | 39 | `orchestration`, `traces` |
...
| `citations` | 82 | 4 | 21 | `commands`, `scan-arxiv`, `vtm` |
...
| `scribe` | 61 | 7 | 25 | `memory` |
| `teams` | 17 | 7 | 9 | `index.ts` |
| `testing` | 14 | 7 | 6 | `chips`, `evaluator`, `index.ts`, `mesh` |
| `traces` | 18 | 7 | 23 | `branches`, `cartridge`, `flywheel`, `orchestration`, `reinforcement` |
| `integration` | 61 | 8 | 45 | `dashboard`, `hooks`, `launcher`, `terminal` |
| `learning` | 19 | 8 | 12 | `index.ts` |
| `observation` | 42 | 8 | 23 | `dashboard`, `hooks`, `learning`, `orchestrator` |
| `tractability` | 9 | 8 | 8 | `ab-harness`, `branches`, `langevin`, `orchestration`, `stochastic` (+2) |
| `chips` | 18 | 9 | 14 | `cartridge`, `citations`, `college`, `eval`, `mcp` (+1) |
| `source-ledger` | 2 | 9 | 7 | `cartridge`, `citations`, `commands`, `learn`, `scan-arxiv` (+1) |
| `application` | 23 | 10 | 17 | `coprocessor`, `index.ts`, `integration`, `retrieval`, `sensoria` (+3) |
| `safety` | 47 | 13 | 25 | `bundles`, `calibration`, `evaluator`, `events`, `learning` (+7) |
| `atlas` | 69 | 14 | 23 | `intelligence` |
| `cli` | 169 | 17 | 73 | `commands`, `scribe`, `skill` |
| `embeddings` | 21 | 19 | 23 | `application`, `conflicts`, `discovery`, `index.ts`, `orchestrator` (+5) |
| `memory` | 70 | 20 | 58 | `application`, `graph`, `intelligence`, `knowledge`, `mcp` (+5) |
...
| `security` | 12 | 43 | 50 | `agc`, `alternative-discoverer`, `amiga`, `aminet`, `atlas` (+32) |
| `storage` | 7 | 43 | 39 | `agents`, `application`, `capabilities`, `chips`, `composition` (+15) |
| `types` | 32 | 90 | 161 | `ace`, `activation`, `agents`, `amiga`, `application` (+53) |
