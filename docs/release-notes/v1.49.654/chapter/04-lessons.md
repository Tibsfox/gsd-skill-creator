...
## 2 forward lessons emitted (#10245–#10246)
...
**Lesson #10245 — Cross-track scaffold-then-fill is a two-milestone pattern.**
...
**Lesson #10246 — Granular bypass token beats blanket bypass when the underlying drift is multi-track.**
...
- **Total lessons emitted to date:** 10246 (cumulative since corpus inception)
- **Lessons emitted this milestone:** 2 (#10245, #10246)
...
- **Open lessons watchlist (apply at next opportunity):**
  - **#10245** (cross-track scaffold-then-fill two-milestone pattern) — applies directly at v1.49.655 W0 brief authoring.
  - **#10246** (granular bypass token) — apply when new pre-tag-gate steps are introduced.
