...
3. **Freeze schemas early and defend them with loader normalizers.**
   ...
   _⚙ Status: `investigate` · lesson #4484_

4. **Build escape hatches on day one, not when you need them.**
   ...
   _⚙ Status: `investigate` · lesson #4485_

5. **Parallel workstreams work when they're isolated at the right boundary.**
   ...
   _⚙ Status: `investigate` · lesson #4486_
...
6. **The crossfade tier model beats binary promote/demote for any live memory system.**
   ...
   _⚙ Status: `investigate` · lesson #4487_
...
7. **Deferral asymmetry dominates warm-start cost.**
   ...
   _⚙ Status: `investigate` · lesson #4488_
...
8. **Non-squash merges preserve mission history.**
   ...
   _⚙ Status: `investigate` · lesson #4489_
...
9. **Process failure fingerprints show up at test suite boundaries.**
   ...
   _⚙ Status: `investigate` · lesson #4490_
...
10. **The omnibus tag matches what shipped, not what was chartered.**
   ...
   _⚙ Status: `investigate` · lesson #4491_
...
11. **The `--allow-validation-debt` escape hatch should have been a Wave 0 primitive.**
   ...
   _⚙ Status: `investigate` · lesson #4492_
...
12. **Packaging version drift caught late.**
   ...
   _⚙ Status: `investigate` · lesson #4493_
...
13. **The `pr-review-gate.sh` experimental hook added friction.**
   ...
   _⚙ Status: `investigate` · lesson #4494_
...
14. **Cross-chipset validation debt surfaced 22 departments of invisible drift.**
   ...
   _⚙ Status: `investigate` · lesson #4495_
