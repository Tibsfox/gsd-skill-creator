...
Generated: 2026-06-05T08:32:51.475Z
Root: `.`

**Summary:** 151 modules — 98 living · 45 test-only · 8 isolated. **Reachability:** 86 reachable-from-production · 65 unreachable-from-production.
...
| `cli` | 137 | 15 | 53 | `commands`, `scribe`, `skill` |
...
| `security` | 10 | 40 | 45 | `agc`, `alternative-discoverer`, `aminet`, `atlas`, `cartridge` (+31) |
| `types` | 32 | 82 | 154 | `ace`, `activation`, `agents`, `application`, `branches` (+50) |
