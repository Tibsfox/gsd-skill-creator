...
**Snapshots considered:** 57 (`v1.49.787` → `v1.49.1007`)
...
|---|---|---|---|
| `activation-steering` | 6 | test-only | v1.49.1002 |
| `agc` | 6 | test-only | v1.49.1002 |
| `alternative-discoverer` | 6 | test-only | v1.49.1002 |
| `aminet` | 6 | test-only | v1.49.1002 |
| `artifactnet-provenance` | 6 | test-only | v1.49.1002 |
| `bounded-learning-empirical` | 6 | test-only | v1.49.1002 |
| `brainstorm` | 6 | test-only | v1.49.1002 |
| `catalog` | 6 | test-only | v1.49.1002 |
| `citations` | 6 | test-only | v1.49.1002 |
| `cloud-ops` | 6 | test-only | v1.49.1002 |
| `code-absorber` | 6 | test-only | v1.49.1002 |
| `compression-spectrum` | 6 | test-only | v1.49.1002 |
| `convergent` | 6 | test-only | v1.49.1002 |
| `dependency-resolver` | 6 | test-only | v1.49.1002 |
| `experience-compression` | 6 | test-only | v1.49.1002 |
| `fl-threat-model` | 6 | test-only | v1.49.1002 |
| `hardware-infrastructure` | 6 | test-only | v1.49.1002 |
| `heuristics-free-skill-space` | 6 | test-only | v1.49.1002 |
| `hooks` | 6 | test-only | v1.49.1002 |
| `intrinsic-telemetry` | 6 | test-only | v1.49.966 |
| `knowledge` | 6 | test-only | v1.49.1002 |
| `launcher` | 6 | test-only | v1.49.1002 |
| `mcp-defense` | 6 | test-only | v1.49.1002 |
| `mission-world-model` | 6 | test-only | v1.49.1002 |
| `promptcluster-batcheffect` | 6 | test-only | v1.49.1002 |
| `random` | 6 | test-only | v1.49.1002 |
| `reasoning-graphs` | 6 | test-only | v1.49.1002 |
| `rumor-delay-model` | 6 | test-only | v1.49.1002 |
| `runtime-hal` | 6 | test-only | v1.49.1002 |
| `scribe` | 6 | test-only | v1.49.1002 |
| `sigreg` | 6 | test-only | v1.49.1002 |
| `skill-creator` | 6 | test-only | v1.49.1002 |
| `skilldex-auditor` | 6 | test-only | v1.49.1002 |
| `spatial-awareness` | 6 | test-only | v1.49.1002 |
| `stackelberg-pricing` | 6 | test-only | v1.49.1002 |
| `token-budget` | 6 | test-only | v1.49.1002 |
| `trust-tiers` | 6 | test-only | v1.49.1002 |
| `utils` | 6 | test-only | v1.49.1002 |
| `vtm` | 6 | test-only | v1.49.1002 |
