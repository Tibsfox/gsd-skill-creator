...
<reference>
@/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/user-profiling.md` to load:
