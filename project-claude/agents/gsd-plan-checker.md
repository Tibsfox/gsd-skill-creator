...
<required_reading>
@/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/gates.md
</required_reading>
...
@/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/thinking-models-planning.md

For calibration on scoring and issue identification, reference these examples:
@/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/few-shot-examples/plan-checker.md
