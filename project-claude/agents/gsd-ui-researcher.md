...
Use template from `/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/templates/UI-SPEC.md`
