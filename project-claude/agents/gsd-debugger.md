...
@/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/mandatory-initial-read.md
...
<required_reading>
@/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>

**Project skills:** @/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/project-skills-discovery.md
...
@/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude
                  → checks /media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done
                  → writes to /media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/hooks/
...
@/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/media/foxy/ai/GSD/dev-tools/gsd-skill-creator/.claude/get-shit-done/references/common-bug-patterns.md
