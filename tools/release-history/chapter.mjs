...
// Re-export for backward compatibility with consumers that import these
// helpers from chapter.mjs (e.g. the existing chapter-idempotent test
// fixture). New consumers should import from `./opener-match.mjs` directly
// to avoid pulling in chapter.mjs's auto-running main() side effect.
export { normalizeOpener, openerMatches };
...
// normalizeOpener / openerMatches were extracted to `./opener-match.mjs` at
// v1.49.836 so publish.mjs can reuse them without triggering this file's
// auto-running main() side effect. They are re-exported above.
// ---------------------------------------------------------------------------
