...
- **nasa worktree** still exists at `/media/foxy/ai/GSD/dev-tools/gsd-skill-creator-nasa` — deprecated, safe to remove with `git worktree remove /media/foxy/ai/GSD/dev-tools/gsd-skill-creator-nasa`
