#!/bin/bash
# Build PNW/COL research site from .planning/output markdown files
# Usage: bash www/PNW/COL/build.sh

set -euo pipefail
cd "$(dirname "$0")/../../.."

SRC=".planning/output"
DST="www/PNW/COL/research"
...
echo "Serve: python3 -m http.server 8080 --directory www/PNW/COL"
