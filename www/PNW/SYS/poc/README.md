...
Browse the PNW research: **http://localhost:3000/** (serves everything under `www/PNW/`)
...
- **`server.staticRoot`**: Relative path from the poc directory to the content root. Default `../../` serves all of `www/PNW/`.
