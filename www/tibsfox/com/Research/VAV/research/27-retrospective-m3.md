...
Each PoC should be self-contained (single script or small module), documented with expected vs actual results, and stored in a `www/tibsfox/com/Research/VAV/poc/` directory.
