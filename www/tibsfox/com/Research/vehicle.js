...
function setup() {
  ...
  // Start with ONLY seeds — no plants, no vehicles
  // Seeds blow in from the edges on the wind
  ...
  for (var i = 0; i < initSeeds; i++) {
    seeds.push({
      ...
      dna: null, // wild seed, no parent DNA
...
function draw() {
  ...
  text(wxLine + '  ' + windLine + '  ' + skyLine + '  ' + ecoLine, 4, height - 5);
}
