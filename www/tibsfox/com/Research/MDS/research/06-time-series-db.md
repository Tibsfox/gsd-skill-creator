...
> **Module:** 6 -- RRD, InfluxDB, Prometheus, TimescaleDB
> **Through-line:** *RRDtool's circular buffer is the consummate architectural elegance move: a fixed-size store that never grows, never requires maintenance, and produces accurate trend data forever.*
