# Telemetry Systems & Protocols

> **Domain:** Markup Languages
> **Module:** 5 -- CCSDS, SNMP, MQTT, OPC-UA
> **Through-line:** *Industrial, aerospace, and IoT telemetry all solve the same problem -- timestamped sensor data at guaranteed rates -- but use incompatible framing. Bridging them requires explicit architectural decisions.*
