# Real-Time & High-Frequency Display Systems

> **Domain:** Markup Languages
> **Module:** 4 -- SVG, Canvas, WebGL, WebSocket
> **Through-line:** *SVG breaks at 1,000 data points. Canvas pushes to 10,000. Only WebGL can render 1M+ at 60fps. Each level requires a fundamentally different programming model.*
