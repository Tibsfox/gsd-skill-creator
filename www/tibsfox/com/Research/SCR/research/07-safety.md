# Safety & Cultural Sovereignty

> **Domain:** gsd-skill-creator
> **Module:** 7 -- OCAP/CARE, Heritage Skills Warden
> **Through-line:** *Safety is not optional. The OCAP/CARE/UNDRIP four-level classification system, the physical safety warden, and 18 cleared red-team scenarios define boundaries that cannot be overridden by credentials or academic exception.*
...
Safety and Cultural Sovereignty represents a core subsystem of the gsd-skill-creator ecosystem. This module documents the architecture, key source files, design decisions, and documentation requirements for producing a complete documentation web that makes every design decision traceable.
