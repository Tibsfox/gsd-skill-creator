# Application Pipeline & Complex Plane

> **Domain:** gsd-skill-creator
> **Module:** 4 -- z=re^itheta, Geometric Scoring
> **Through-line:** *Skills are modeled as complex numbers on a unit circle. Position (theta) encodes domain, magnitude (r) encodes confidence. The tangent activation engine uses geometric proximity to determine which skills fire for a given context.*
...
Application Pipeline and Complex Plane represents a core subsystem of the gsd-skill-creator ecosystem. This module documents the architecture, key source files, design decisions, and documentation requirements for producing a complete documentation web that makes every design decision traceable.
