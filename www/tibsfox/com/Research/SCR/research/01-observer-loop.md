# Core Observer-Detective Loop

> **Domain:** gsd-skill-creator
> **Module:** 1 -- Observe, Detect, Suggest, Learn
> **Through-line:** *The six-step lifecycle is the heartbeat of the skill-creator: Observe, Detect, Suggest, Manage, Auto-Load, Learn/Compose. Every session feeds the loop. Every correction refines it. The TranscriptParser streams JSONL without loading the full file, a deliberate memory-efficient design.*
...
Core Observer-Detective Loop represents a core subsystem of the gsd-skill-creator ecosystem. This module documents the architecture, key source files, design decisions, and documentation requirements for producing a complete documentation web that makes every design decision traceable.
