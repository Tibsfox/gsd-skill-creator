...
> **Module:** 2 -- Fidelity 0-4, Bus Opcodes, Bundles
> **Through-line:** *DACP is the central architectural thesis: agent communication should pass structured three-part bundles (intent + data + code), not ambiguous markdown. FidelityLevel 0-4 defines the spectrum from raw text to fully validated deterministic bundles.*
...
DACP Protocol represents a core subsystem of the gsd-skill-creator ecosystem. This module documents the architecture, key source files, design decisions, and documentation requirements for producing a complete documentation web that makes every design decision traceable.
