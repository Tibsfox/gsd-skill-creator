...
> **Module:** 8 -- Commands, Actions, Documentation Web
> **Through-line:** *The CLI is the entry point. GitHub Actions provides CI/CD. The documentation web at www/tibsfox connects research modules to the codebase. Infrastructure patterns support both development and user modes.*
...
CLI and Infrastructure represents a core subsystem of the gsd-skill-creator ecosystem. This module documents the architecture, key source files, design decisions, and documentation requirements for producing a complete documentation web that makes every design decision traceable.
