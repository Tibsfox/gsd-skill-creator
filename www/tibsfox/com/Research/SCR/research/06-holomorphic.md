# Holomorphic Mathematics Engine

> **Domain:** gsd-skill-creator
> **Module:** 6 -- DMD, Koopman, Julia Sets
> **Through-line:** *The holomorphic mathematics module models skill dynamics as complex dynamical systems. DMD decomposes temporal patterns, Koopman operators linearize nonlinear dynamics, and Julia set computation maps stability boundaries.*
...
Holomorphic Mathematics Engine represents a core subsystem of the gsd-skill-creator ecosystem. This module documents the architecture, key source files, design decisions, and documentation requirements for producing a complete documentation web that makes every design decision traceable.
