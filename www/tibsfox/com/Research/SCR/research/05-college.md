...
> **Module:** 5 -- 42 Departments, Rosetta Core
> **Through-line:** *The College organizes knowledge into 42 academic departments, each with RosettaConcept cross-reference files. Priority tiers enable progressive disclosure: core concepts surface first, specialized knowledge loads on demand.*
...
College of Knowledge represents a core subsystem of the gsd-skill-creator ecosystem. This module documents the architecture, key source files, design decisions, and documentation requirements for producing a complete documentation web that makes every design decision traceable.
