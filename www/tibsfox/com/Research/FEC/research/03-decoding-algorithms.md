...
> **Module:** 3 -- Viterbi, Belief Propagation, Neural Decoders
> **Through-line:** *The encoder weaves redundancy into the message. The decoder unweaves it. The best decoders do not enumerate codewords. They propagate beliefs through graph structures until the most probable transmitted word emerges from the noise.*
...
Decoding Algorithms addresses a critical dimension of forward error correction theory and practice. This module examines the mathematical foundations, engineering tradeoffs, and deployed systems that define how structured redundancy protects information against channel noise.
