# Code Families Taxonomy

> **Domain:** Forward Error Correction
> **Module:** 2 -- Hamming, BCH, RS, LDPC, Polar, Turbo, Raptor
> **Through-line:** *Every code family represents a different answer to the same question: how do you add structured redundancy to a message so that the geometry of the code space protects it from noise? The answers range from Hamming's elegant 1950 construction to the sparse graphs of modern LDPC.*
...
Code Families Taxonomy addresses a critical dimension of forward error correction theory and practice. This module examines the mathematical foundations, engineering tradeoffs, and deployed systems that define how structured redundancy protects information against channel noise.
