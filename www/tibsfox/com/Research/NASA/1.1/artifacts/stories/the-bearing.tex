...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textit{The Bearing}}
\fancyhead[R]{\small\textit{NASA Mission Series v1.1}}
\fancyfoot[C]{\small\thepage}
\renewcommand{\headrulewidth}{0.4pt}

\title{\Huge\textbf{The Bearing}\\[0.5em]\large\textit{A short story from Mission 1.1 --- Pioneer 0}}
...
\vspace{2em}
\begin{center}
\textit{For Pearl Bailey (March 29, 1918 --- August 17, 1990),\\who was also the first, and who also prepared the ground.}
\end{center}
