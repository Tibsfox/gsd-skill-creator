...
(function() {
  var projects = [
    ...
    { id: 'AGT', name: 'Agentic Technologies', path: 'AGT/index.html' },
    { id: 'AIH', name: 'AI Horizon', path: 'AIH/index.html' },
    { id: 'ALR', name: 'Learning Resources', path: 'ALR/index.html' },
    { id: 'AMS', name: 'Artemis Math & Science', path: 'AMS/index.html' },
    { id: 'APD', name: 'Papers Deep Dive', path: 'APD/index.html' },
    ...
    { id: 'GPE', name: 'Global Power Efficiency', path: 'GPE/index.html' },
    ...
    { id: 'GSI', name: 'GSD Improvements', path: 'GSI/index.html' },
    { id: 'HFE', name: 'Audio Engineering', path: 'HFE/index.html' },
    { id: 'HPC', name: 'High Performance Computing', path: 'HPC/index.html' },
    ...
    { id: 'MAS', name: 'Multi-Agent Systems', path: 'MAS/index.html' },
    ...
    { id: 'MDB', name: 'Moody Blues', path: 'MDB/index.html' },
    ...
    { id: 'PPP', name: 'Picnic Point Park', path: 'PPP/index.html' },
    { id: 'PPS', name: 'Picnic Point Parking Structure', path: 'PPS/index.html' },
    { id: 'PRS', name: 'Polyrhythm Standard', path: 'PRS/index.html' },
    { id: 'PSC', name: 'Political Science & Complex Plane', path: 'PSC/index.html' },
    { id: 'PSH', name: 'Possession Sound Heritage', path: 'PSH/index.html' },
    ...
    { id: 'RCA', name: 'Root Cause Analysis', path: 'RCA/index.html' },
    ...
    { id: 'SAA', name: 'Skills, Agents & Teams', path: 'SAA/index.html' },
    ...
    { id: 'SYA', name: 'Systems Administration Deep Dive', path: 'SYA/index.html' },
  ...
  var clusters = [
    { name: 'Ecology', color: '#4CAF50', ids: ['COL','CAS','ECO','GDN','AVI','MAM','AWF','SAL','CRV','PLT','AGR','LFR','PPM','BHM','SSM','CDS','SFC','MWC','PSH'] },
    { name: 'Electronics', color: '#FFB300', ids: ['SHE','LED','T55','EMG','BPS','PSS','SNL','HFR','HFE','FEC'] },
    { name: 'Infrastructure', color: '#78909C', ids: ['SYS','CMH','GSD2','MPC','VAV','OCN','K8S','MCM','PMG','ACE','MCF','MCS','STE','WPH','MRW','GPO','GPG','PIN','SRD','MDS','SCR','DHP','DNS','TCP','PNP','RFC','ENB','HPC','RCA','SYA'] },
    { name: 'Energy', color: '#FF7043', ids: ['THE','HGE','NND','GPE'] },
