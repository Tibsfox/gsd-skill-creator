// Wing 6: Category Theory — "Arrows"
// Container component managing 6-phase progression: wonder -> see -> touch -> understand -> connect -> create
// Teaching anchor: Category theory is how trees hold knowledge and share it.
// The functor is the faithful retelling: the structure survives the journey.
...
export default function CategoryTheoryWing({
  foundationId,
  learnerState,
  onPhaseComplete,
  onCreationSave,
  ...
  return (
    <div className="wing wing--category-theory" data-foundation="category-theory">
      <header className="wing__header">
        <h1 className="wing__title">Category Theory</h1>
        <p className="wing__subtitle">Arrows</p>
