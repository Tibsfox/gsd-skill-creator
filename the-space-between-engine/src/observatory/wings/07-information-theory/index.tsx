// Wing 7: Information Theory — "The Channel"
// Container component managing 6-phase progression: wonder -> see -> touch -> understand -> connect -> create
// Teaching anchor: "How much of the message can be lost before the meaning dies?"
// IS Shannon's theorem. Birdsong resurfaces. Compass fox returns as RECEIVER.
...
export default function InformationTheoryWing({
  foundationId,
  learnerState,
  onPhaseComplete,
  onCreationSave,
  ...
  return (
    <div className="wing wing--information-theory" data-foundation="information-theory">
      <header className="wing__header">
        <h1 className="wing__title">Information Theory</h1>
        <p className="wing__subtitle">The Channel</p>
