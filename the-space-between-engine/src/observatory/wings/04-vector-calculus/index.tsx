...
export interface VectorCalculusWingProps {
...
export const WING_ID: FoundationId = 'vector-calculus';
export const WING_NAME = 'Vector Calculus';
export const WING_SUBTITLE = 'Fields';

export const VectorCalculusWing: React.FC<VectorCalculusWingProps> = ({
  foundationId,
  learnerState,
  onPhaseComplete,
  onNavigate,
  ...
  return (
    <div className="wing vector-calculus-wing">
      <header className="wing-header">
        <h1>Wing 4: {WING_NAME}</h1>
...
export default VectorCalculusWing;
