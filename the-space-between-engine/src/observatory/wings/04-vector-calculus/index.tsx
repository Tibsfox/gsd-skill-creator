...
export default function VectorCalculusWing({
  foundationId,
  learnerState,
  onPhaseComplete,
  onCreationSave,
  ...
  return (
    <div className="wing wing--vector-calculus" data-foundation="vector-calculus">
      <header className="wing__header">
        <h1 className="wing__title">Vector Calculus</h1>
        <p className="wing__subtitle">Fields</p>
