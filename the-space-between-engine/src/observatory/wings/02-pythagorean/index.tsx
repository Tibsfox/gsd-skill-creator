// Wing 2: Pythagorean — "Relationship"
...
export default function PythagoreanWing({
  foundationId,
  learnerState,
  onPhaseComplete,
  onCreationSave,
  ...
  return (
    <div className="wing wing--pythagorean" data-foundation="pythagorean">
      <header className="wing__header">
        <h1 className="wing__title">Pythagorean</h1>
        <p className="wing__subtitle">Relationship</p>
