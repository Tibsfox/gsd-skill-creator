...
export default function TrigonometryWing({
  foundationId,
  learnerState,
  onPhaseComplete,
  onCreationSave,
  ...
  return (
    <div className="wing wing--trigonometry" data-foundation="trigonometry">
      <header className="wing__header">
        <h1 className="wing__title">Trigonometry</h1>
        <p className="wing__subtitle">Motion</p>
