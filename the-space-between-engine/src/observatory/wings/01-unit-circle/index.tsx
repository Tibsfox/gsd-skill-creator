...
export default function UnitCircleWing({
  foundationId,
  learnerState,
  onPhaseComplete,
  onCreationSave,
  ...
  return (
    <div className="wing wing--unit-circle" data-foundation="unit-circle">
      <header className="wing__header">
        <h1 className="wing__title">Unit Circle</h1>
        <p className="wing__subtitle">Seeing</p>
