/**
 * Wing 8: L-Systems — "Growth"
 *
 * The final wing. Container managing phase progression.
 * From wonder at natural growth to creating your own garden.
 * The circle closes here: L-systems use the unit circle,
 * and so the last wing connects to the first.
 * Begin again.
 */

import React, { useState, useCallback } from 'react';
import type { PhaseType } from '../../../types/index.js';
...
export interface LSystemsWingProps {
...
const FOUNDATION_ID = 'l-systems' as const;

export const LSystemsWing: React.FC<LSystemsWingProps> = ({
  initialPhase = 'wonder',
  onPhaseComplete,
  onWingComplete,
  onSaveCreation,
  ...
  return (
    <div className="observatory-wing l-systems-wing">
