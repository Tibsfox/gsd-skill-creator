...
// Same thrush that taught trigonometry (wave) and information theory (channel) now teaches growth.
...
export default function LSystemsWing({
  foundationId,
  learnerState,
  onPhaseComplete,
  onCreationSave,
  ...
  return (
    <div className="wing wing--l-systems" data-foundation="l-systems">
      <header className="wing__header">
        <h1 className="wing__title">L-Systems</h1>
        <p className="wing__subtitle">Growth</p>
