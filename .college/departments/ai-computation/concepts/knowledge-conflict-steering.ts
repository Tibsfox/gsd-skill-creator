...
export const knowledgeConflictSteering: RosettaConcept = {
  ...
  description:
    "Retrieval-augmented models must decide, when a retrieved passage contradicts what their weights encode, whether to trust the context or their parametric memory — a context-versus-parametric knowledge conflict. Neuron-level edits that force contextual reliance tend to damage unrelated capabilities because the responsible neurons are entangled. SHIFT (arXiv 2606.27786) reframes the intervention as learnable gate modulation of activations: a lightweight gate rescales hidden units so the model adaptively defers to contextual evidence, resolving conflict without the cascading capability loss of editing entangled neurons directly.",
  panels: new Map(),
  relationships: [
    {
      type: "dependency",
