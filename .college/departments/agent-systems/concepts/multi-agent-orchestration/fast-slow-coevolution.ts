...
export const fastSlowCoevolution: RosettaConcept = {
  ...
  description:
    ...
    'capability per-trajectory, and a slow loop that evolves the topology — births, deaths, merges, splits — at ' +
    'meta-level intervals. The 2026 framing (TacoMAS, arxiv `2605.09539`) makes the separation explicit: capability ' +
    'updates are cheap and local; topology updates are expensive and global, so they must be amortised across many ' +
    'trajectories. The pattern recurs across the 2026 frontier (Theme D: two timescales) — per-task probe-and-prefill / ' +
