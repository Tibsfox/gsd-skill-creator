...
export const activeExperimentalist: RosettaConcept = {
  ...
  description:
    "Hierarchical Experimentalist Agents (HExA) is a training-free, in-context self-improvement framework that lets a black-box LLM learn by actively experimenting rather than relying on parametric knowledge, retrieval, or search (arXiv 2606.29315, 2026). Facing a novel long-horizon task, HExA iteratively designs and refines query-relevant experiments, runs them through simulation or tool APIs, distills a reusable library of composable skills from the resulting experience, and integrates the accumulated evidence to answer the query or act. It requires no external supervision, oracles, or offline data. Its distinct contribution is closing the gap between knowing facts and acting competently in unfamiliar systems: on the Interphyre physics benchmark it lifts a weak baseline dramatically, and its learned skills transfer to harder levels without further experimentation. For agent builders, it argues that runtime intervention and hypothesis testing should be first-class capabilities, not just recall.",
  panels: new Map(),
  relationships: [
    {
      type: "dependency",
