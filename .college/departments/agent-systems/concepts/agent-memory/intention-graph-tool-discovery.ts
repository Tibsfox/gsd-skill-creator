...
export const intentionGraphToolDiscovery: RosettaConcept = {
  ...
  description:
    "Agents working over large, open-world tool inventories must surface the few relevant tools, but one-shot retrieval over isolated tool descriptions ignores that task intent keeps evolving as the agent decomposes goals, observes results, and induces subgoals. The Intention Graph (arXiv 2606.16591) synthesizes and continuously updates a graph of the agent's task intent, then matches candidate tools against this evolving structure instead of a static query embedding. This reframes tool discovery as an active, context-tracking process: it improves recall in inventories too large to fit in context and re-scopes selection as the plan unfolds, rather than committing to one retrieval pass at the start.",
  panels: new Map(),
  relationships: [
    {
      type: "dependency",
