...
export const transformUncertaintyPrincipleSession: TrySessionDefinition = {
  ...
  steps: [
    ...
    {
      instruction:
        'Close by placing the result in context. The classical Heisenberg principle bounds the product of time and frequency spreads on the real line; here the analogue bounds a sum of exact support counts on a finite cyclic group. Read the arXiv:2606.08662 (2026) framing: the same sharp bound carries to the number-theoretic transform over a finite field, where omega is a primitive root of unity in the field and arithmetic is exact and modular.',
      expectedOutcome:
        'You articulate the transform uncertainty principle as the finite, exact-count analogue of Heisenberg\'s inequality, and you see the number-theoretic transform inherits the same sparsity trade-off that underpins exact and modular signal processing.',
